...
const produtosNoCarrinho = [
  { id: '1', nome: 'Monitor Gamer', preco: 79.90, imagem: 'https://via.placeholder.com/150', quantidade: 1 },
  { id: '2', nome: 'Teclado Mecânico', preco: 299.90, imagem: 'https://via.placeholder.com/150', quantidade: 2 },
];


const total = produtosNoCarrinho.reduce((acc, item) => acc + (item.preco * item.quantidade), 0);
